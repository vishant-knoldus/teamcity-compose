...
open class VersionedSettings : ProjectFeature {
    constructor(init: VersionedSettings.() -> Unit = {}, base: VersionedSettings? = null): super(base = base as ProjectFeature?) {
 ...
 * @see VersionedSettings
 */
fun ProjectFeatures.versionedSettings(base: VersionedSettings? = null, init: VersionedSettings.() -> Unit = {}) {
    feature(VersionedSettings(init, base))
}
