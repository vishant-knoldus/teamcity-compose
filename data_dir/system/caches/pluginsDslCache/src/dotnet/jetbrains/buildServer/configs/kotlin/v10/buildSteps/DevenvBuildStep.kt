...
open class DevenvBuildStep : BuildStep {
    constructor(init: DevenvBuildStep.() -> Unit = {}, base: DevenvBuildStep? = null): super(base = base as BuildStep?) {
        type = "dotnet"
    ...
    enum class VSVersion {
        ...
        companion object {
            val mapping = mapOf<VSVersion, String>(Any to "VisualStudio_Windows", V16 to "VisualStudio_16_Windows", V15 to "VisualStudio_15_Windows", V14 to "VisualStudio_14_Windows", V12 to "VisualStudio_12_Windows", V11 to "VisualStudio_11_Windows", V10 to "VisualStudio_10_Windows")
        }
 ...
 * @see DevenvBuildStep
 */
fun BuildSteps.dotnetDevenv(base: DevenvBuildStep? = null, init: DevenvBuildStep.() -> Unit = {}) {
    step(DevenvBuildStep(init, base))
}
