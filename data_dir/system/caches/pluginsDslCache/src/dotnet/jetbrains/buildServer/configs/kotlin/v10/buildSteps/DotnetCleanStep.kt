...
open class DotnetCleanStep : BuildStep {
    constructor(init: DotnetCleanStep.() -> Unit = {}, base: DotnetCleanStep? = null): super(base = base as BuildStep?) {
        type = "dotnet"
        param("command", "clean")
        init()
    }
 ...
 * @see DotnetCleanStep
 */
fun BuildSteps.dotnetClean(base: DotnetCleanStep? = null, init: DotnetCleanStep.() -> Unit = {}) {
    step(DotnetCleanStep(init, base))
}
