...
open class DotnetCustomStep : BuildStep {
    constructor(init: DotnetCustomStep.() -> Unit = {}, base: DotnetCustomStep? = null): super(base = base as BuildStep?) {
        type = "dotnet"
 ...
 */
fun BuildSteps.dotnetCustom(base: DotnetCustomStep? = null, init: DotnetCustomStep.() -> Unit = {}) {
    step(DotnetCustomStep(init, base))
}
