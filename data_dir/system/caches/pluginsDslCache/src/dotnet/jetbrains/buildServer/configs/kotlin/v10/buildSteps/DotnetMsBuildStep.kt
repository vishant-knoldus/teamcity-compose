...
open class DotnetMsBuildStep : BuildStep {
    constructor(init: DotnetMsBuildStep.() -> Unit = {}, base: DotnetMsBuildStep? = null): super(base = base as BuildStep?) {
        type = "dotnet"
    ...
    enum class MSBuildVersion {
        ...
        companion object {
            val mapping = mapOf<MSBuildVersion, String>(CrossPlatform to "MSBuild_CrossPlatform", V16 to "MSBuild_16_Windows", V15 to "MSBuild_15_Windows", V14 to "MSBuild_14_Windows", V12 to "MSBuild_12_Windows", V4 to "MSBuild_4_Windows")
        }
 ...
 */
fun BuildSteps.dotnetMsBuild(base: DotnetMsBuildStep? = null, init: DotnetMsBuildStep.() -> Unit = {}) {
    step(DotnetMsBuildStep(init, base))
}
