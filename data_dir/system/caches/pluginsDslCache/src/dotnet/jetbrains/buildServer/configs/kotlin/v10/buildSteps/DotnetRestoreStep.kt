...
open class DotnetRestoreStep : BuildStep {
    constructor(init: DotnetRestoreStep.() -> Unit = {}, base: DotnetRestoreStep? = null): super(base = base as BuildStep?) {
        type = "dotnet"
 ...
 */
fun BuildSteps.dotnetRestore(base: DotnetRestoreStep? = null, init: DotnetRestoreStep.() -> Unit = {}) {
    step(DotnetRestoreStep(init, base))
}
