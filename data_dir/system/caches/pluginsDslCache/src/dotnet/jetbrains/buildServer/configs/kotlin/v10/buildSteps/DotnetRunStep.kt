...
open class DotnetRunStep : BuildStep {
    constructor(init: DotnetRunStep.() -> Unit = {}, base: DotnetRunStep? = null): super(base = base as BuildStep?) {
        type = "dotnet"
        param("command", "run")
        init()
    }
 ...
 * @see DotnetRunStep
 */
fun BuildSteps.dotnetRun(base: DotnetRunStep? = null, init: DotnetRunStep.() -> Unit = {}) {
    step(DotnetRunStep(init, base))
}
