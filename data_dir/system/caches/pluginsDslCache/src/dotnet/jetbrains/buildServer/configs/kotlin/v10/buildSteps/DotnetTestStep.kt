...
open class DotnetTestStep : BuildStep {
    constructor(init: DotnetTestStep.() -> Unit = {}, base: DotnetTestStep? = null): super(base = base as BuildStep?) {
        type = "dotnet"
        param("command", "test")
        init()
    }
 ...
 * @see DotnetTestStep
 */
fun BuildSteps.dotnetTest(base: DotnetTestStep? = null, init: DotnetTestStep.() -> Unit = {}) {
    step(DotnetTestStep(init, base))
}
