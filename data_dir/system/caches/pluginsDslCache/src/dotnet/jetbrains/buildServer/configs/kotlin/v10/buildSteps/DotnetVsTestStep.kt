...
open class DotnetVsTestStep : BuildStep {
    constructor(init: DotnetVsTestStep.() -> Unit = {}, base: DotnetVsTestStep? = null): super(base = base as BuildStep?) {
        type = "dotnet"
    ...
    sealed class Filter(value: String? = null): CompoundParam(value) {
    ...
    enum class VSTestVersion {
        ...
        companion object {
            val mapping = mapOf<VSTestVersion, String>(CrossPlatform to "VSTest_CrossPlatform", V16 to "VSTest_16_Windows", V15 to "VSTest_15_Windows", V14 to "VSTest_14_Windows", V12 to "VSTest_12_Windows")
        }
 ...
 */
fun BuildSteps.dotnetVsTest(base: DotnetVsTestStep? = null, init: DotnetVsTestStep.() -> Unit = {}) {
    step(DotnetVsTestStep(init, base))
}
