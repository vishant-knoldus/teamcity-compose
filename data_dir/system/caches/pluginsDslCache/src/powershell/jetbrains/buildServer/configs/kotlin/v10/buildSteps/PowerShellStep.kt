...
open class PowerShellStep : BuildStep {
    constructor(init: PowerShellStep.() -> Unit = {}, base: PowerShellStep? = null): super(base = base as BuildStep?) {
    ...
    sealed class ScriptMode(value: String? = null): CompoundParam(value) {
 ...
 * @see PowerShellStep
 */
fun BuildSteps.powerShell(base: PowerShellStep? = null, init: PowerShellStep.() -> Unit = {}) {
    step(PowerShellStep(init, base))
}
